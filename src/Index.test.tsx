...
describe('application tests', () => {
  ...
  it('should render name: KAJAL KUMARI', () => {
    const element = screen.getByTestId('name');

    checkContent(element, /^KAJAL KUMARI$/);
  });
  ...
  it('should render creator', () => {
    ...
    checkContent(element, /^Gyan Prakash$/, '#');
  });
  ...
  it('should render GitHub button', () => {
    ...
    checkButton(parent, child, /^GitHub$/, 'https://github.com/kajaldotpy');
  });
  ...
  it('should render Email button', () => {
    ...
    checkButton(parent, child, /^Email$/, 'mailto:cskajalmain@gmail.com');
  });
  ...
  it('should render full footer on desktop', () => {
    ...
    expect(footer).toHaveTextContent(
      /^Designed and built by Gyan Prakash \| Source$/
    );
  });
});
...
describe('app context tests', () => {
  it('should render partial footer on mobile', () => {
    ...
    expect(footer).toHaveTextContent(/^Designed and built by Gyan Prakash$/);
